...
class PrepareVideoList {
    ...
    fun getList(): List<VideoInfo> {
        ...
        val projection = arrayOf(MediaStore.Video.VideoColumns.DATA, MediaStore.Video.VideoColumns.SIZE, MediaStore.Video.VideoColumns.DATE_ADDED)
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                if (path != null) {
                    ...
                    val lastModified = c.getLong(c.getColumnIndexOrThrow(MediaStore.Video.Media.DATE_ADDED))
